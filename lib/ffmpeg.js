...
var ffmpeg = function (/* inputFilepath, settings, callback */) {
	...
	/**
	 * Retrieve the list of codecs supported by the ffmpeg software
	 */
	var _ffmpegInfoConfiguration = function (settings) {
		// New 'promise' instance 
		var deferred = when.defer();
		// Instantiate the new arrays for the format
	...
	var __constructor = function (args) {
		...
		when(_getInformation(inputFilepath, settings), function (data) {
			...
			if (typeof callback == 'function') {
				// Call the callback function and return the new instance of 'video' class
			...
			// Check if the callback is a function
			if (typeof callback == 'function') {
				// Call the callback function and return the error found
				callback(error, null);
			} else {
				// Negative response
