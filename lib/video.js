...
module.exports = function (filePath, settings, infoConfiguration, infoFile) {
	...
	this.fnExtractFrameToJPG = function (/* destinationFolder, settings, callback */) {
		...
		// Check if the value of the qscale is number type
        if (settings.qscale != null && isNaN(settings.qscale))
            settings.qscale = null;
		...
		if (settings.qscale)
            this.addCommand('-qscale:v', settings.qscale);
